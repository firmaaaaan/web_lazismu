...
<div class="page-body">
    <div class="container-xl">
        <div class="row justify-content-center">
            ...
            <form action="{{ route('zakat.storeSalurkan', $zakat->id) }}" method="POST">
                @csrf
                <div class="card mt-3">
                    <div class="card-body">
                        <input type="hidden" name="id" class="form-control" id="id" value="{{ $zakat->id }}">
                        <div class="bg-light rounded d-flex align items center p-3">
                            <h1 class="font-weight-bold w-25">Rp.</h1>
                            <input type="number" class="form-control" name="zakat_tersalurkan" id="id">
