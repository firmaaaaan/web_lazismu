                    ...
                    <div class="card mt-3">
                        <div class="card-body">
                            <div class="bg-light rounded d-flex align items center p-3">
                                ...
                                <input type="number" class="form-control" name="nominal" placeholder="Masukan nominal zakat" value="0">
                            </div>
                            <div class="bg-light rounded d-flex align items center p-3">
                                <h1 class="font-weight-bold w-25">Kg.</h1>
                                <input type="number" class="form-control" name="nominal_beras" placeholder="Masukan nominal zakat" value="0">
                            </div>
                            ...
                            <div class="form-group mt-2">
                                ...
                                <small>Diisi jika zakat yang dikeluarkan berupa uang</small>
                            </div>
                            </div>
